          ...
          <div class="well well-sm">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p>
                  <span class="label label-info">{{ $vinyl->releasedate }}</span> <span class="label label-primary">{{ $vinyl->genre }}</span> <span class="label label-warning">{{ $vinyl->label }}</span> <span class="label label-success">{{ $vinyl->country }}</span> <span class="label label-default">{{ $vinyl->type }}</span> <span class="label label-default">{{ $vinyl->count }}x {{ $vinyl->size }}inch</span></p>
                </p>
              </div>
            </div>
          </div>  
